...
```mermaid
flowchart TD
    A["👤 Client<br/>Web e Mobile (Memória Local)"]
    B["⚙️ Backend FastAPI<br/>Stateless (0 Dias de Log)"]
    C["🔀 OpenRouter Proxy<br/>Sem Registro (No-Logging)"]
    D["🤖 OpenAI API<br/>Zero Training (Sem Treinamento)"]
